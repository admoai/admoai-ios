...
## [1.4.1](https://github.com/admoai/admoai-ios/admoai/admoai-ios/compare/v1.4.0...v1.4.1) (2026-05-27)


### Documentation

* consolidate duplicate v1.4.0 CHANGELOG entries ([#23](https://github.com/admoai/admoai-ios/admoai/admoai-ios/issues/23)) ([21495ad](https://github.com/admoai/admoai-ios/admoai/admoai-ios/commit/21495ad1fe2c752dcc8ef8f644a06f0ab5f02aa2))
...
* `AdMoai.init(config:userConfig:)` — the `userConfig` parameter was silently ignored and always overwritten with `.clear()` ([#18](https://github.com/admoai/admoai-ios/pull/18))

### Breaking Changes

* `Metadata.priority` type changed from `String` to `Priority`. Consumers reading this field must switch to enum cases or use `.rawValue` to retrieve the underlying string.

## [1.3.0](https://github.com/admoai/admoai-ios/admoai/admoai-ios/compare/v1.2.0...v1.3.0) (2026-01-08)


### Added

* add destination targeting sdk and sample app function ([#9](https://github.com/admoai/admoai-ios/admoai/admoai-ios/issues/9)) ([e49dc76](https://github.com/admoai/admoai-ios/admoai/admoai-ios/commit/e49dc769d31cbb1d694f53db0723ba59bf5eef3c))

## [1.2.0](https://github.com/admoai/admoai-ios/admoai/admoai-ios/compare/v1.1.1...v1.2.0) (2025-12-12)
...
* init ([2005d2c](https://github.com/admoai/admoai-ios/admoai/admoai-ios/commit/2005d2c8af826d8070a58de65762605c849b8fdc))
...
* release 1.1.0 ([#2](https://github.com/admoai/admoai-ios/admoai/admoai-ios/issues/2)) ([663d76f](https://github.com/admoai/admoai-ios/admoai/admoai-ios/commit/663d76fa82282cb73b82a0a79375f99832922800))
...
* update tests ([93e1757](https://github.com/admoai/admoai-ios/admoai/admoai-ios/commit/93e1757ebce9b7f8789784aa430c5c53e10c3672))
